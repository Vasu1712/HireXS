            ...
            <div className="flex">
                ...
                <div className="fcf-form-group w-full">
                    ...
                    <div className="fcf-input-group">
                        <input type="text" id="Name" name="Name" className="fcf-form-control h-8 mt-2 rounded w-96" required />
                    </div>
                </div>
                ...
                <div className="fcf-form-group mt-8">
                    ...
                    <div className="fcf-input-group">
                        <input type="email" id="Email" name="Email" className="fcf-form-control h-8 mt-2 rounded w-96" required />
                    </div>
                </div>
                ...
                <div className="fcf-form-group mt-8">
                    ...
                    <div className="fcf-input-group">
                        <textarea id="Message" name="Message" className="fcf-form-control mt-2 rounded w-96" rows="6" maxLength="3000" required></textarea>
                    </div>
                </div>
