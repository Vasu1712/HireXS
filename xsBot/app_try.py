...
def main():
    ...
    questions = ['What is the difference between Mutex and Semaphore?',
                 'Have you previously worked with React.JS? If yes, elaborate.',
                 'What are the responsibilites of a Senior Software Engineer?',
                 'What is abstraction in Object Oriented Programming?',
                 'Explain Radis in one sentence.']
